...
describe("Exercice 13", function() {
  it("Chercher si dans la chaîne de caractère se trouve \"Afpa\"", function() {
    let sentence = "Afpa : formation professionnelle, formation adulte, formation-continue, VAE // AFPA  | Afpa";
